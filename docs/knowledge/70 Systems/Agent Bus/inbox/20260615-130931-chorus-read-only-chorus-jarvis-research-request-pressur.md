---
type: agent-bus-task
id: 20260615-130931-chorus-read-only-chorus-jarvis-research-request-pressur
created: 2026-06-15 13:09:31
source: telegram
requested_agent: chorus
priority: normal
status: inbox
---

# READ-ONLY CHORUS/JARVIS RESEARCH REQUEST: pressure-test Plain Bible Manual 2.0 as a premiu

## Request

READ-ONLY CHORUS/JARVIS RESEARCH REQUEST: pressure-test Plain Bible Manual 2.0 as a premium Bible-study PDF plus possible buyer-only AI coach. Context: Dead Hidden sells KJV-only PDF field manuals. Verified current Plain Bible public/funnel truth for this build is $10, 135 pages, instant PDF; Chart add-on $5; Vault $365. Ignore stale MarketingSecrets Brain facts claiming 362 pages, Chart $7, Vault $197/$297, wedding fundraiser, countdowns, or unverified testimonials. Purchased Pensacola Bible Baptist materials are research-only: do not quote, copy, bundle, or summarize copyrighted source prose into the product. Task: research/compare similar premium Bible study guides, digital studies, reading-plan products, and Bible AI assistants. Return concise recommendations: 1) formatting patterns worth borrowing ethically, 2) product bundle structure for Plain Bible 2.0, 3) AI coach idea that feels high value without replacing Scripture/pastors or hallucinating doctrine, 4) pricing/positioning cautions, 5) what to avoid. Draft-only. Do not publish, post, email, create Stripe links, or modify any account.
...
Generated: 2026-06-15 13:09 CDT
...
| Chrome CDP | Expected on `localhost:9222` | Use for authenticated browser state, not public web fetch. |
...
`/Users/adamjohnsson/Documents/Obsidian Vault/70 Systems/Agent Bus/results/20260615-130931-chorus-read-only-chorus-jarvis-research-request-pressur.md`
