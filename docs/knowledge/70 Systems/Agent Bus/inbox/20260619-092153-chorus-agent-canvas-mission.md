---
type: agent-bus-task
id: 20260619-092153-chorus-agent-canvas-mission
created: 2026-06-19 09:21:53
source: telegram
...
Shared canvas memory, append-only JSONL:
- Adam: How does this thing work?
...
Chorus/Jarvis lane:
- Read-only connected-app audit only unless Adam approves a specific write.
- You cannot read local Mac paths directly, so rely on pasted packet content and returned URLs/screenshots/notes.
- Return proof links or exact claims that Codex should verify locally.
...
Generated: 2026-06-19 09:21 CDT
...
`/Users/adamjohnsson/Documents/Obsidian Vault/70 Systems/Agent Bus/results/20260619-092153-chorus-agent-canvas-mission.md`
