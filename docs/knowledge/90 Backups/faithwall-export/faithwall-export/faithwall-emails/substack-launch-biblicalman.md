# FaithWall Launch Email — biblicalman Substack
...
**C.** Build a wall for your family's attention
...
- **Set family modes** — different rules for your phone and your household devices, all from one account
...
[**Get FaithWall for your family →**](https://faithwall.deadhidden.org)
...
P.S. — If you're on the fence: ask your household what they think about your screen time. Their answer might be the nudge you need. Then go build that wall together.
