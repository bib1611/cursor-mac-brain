...
- **Source:** https://edlatimore.com/chess-improvement-plan
- **Date:** 2022-09-11T20:50:00.000Z
- **Captured:** read-only public web scrape 2026-06-20 18:43
- **Length:** 19598 chars

## Body (verbatim, study/swipe)

This post outlines the plan I’ll follow to increase my ELO chess rating on [chess.com](http://chess.com/). While I may play in some over-the-board (OTB) tournaments, I’ll be working this plan on [chess.com](http://chess.com/) because I can always log on and get a game at any time control.
...
2. I’m just a regular dude who likes to play chess. I’m not a titled player. I’m not even a particularly strong player. But I am a serious player and will track my progress on [Chess.com](http://chess.com/). If you want to play me, my handle over there is [Ed\_Latimore.](https://www.chess.com/member/ed_latimore)
...
The two ratings on [chess.com](http://chess.com/) that I’ll be keeping track of are my daily and rapid ratings.
...
My stats as of publishing this article
...
This is the type of silly blunder I want to start avoiding
...
[Chess.com](http://chess.com/) has a nearly endless array of tactical exercises randomly presented to you.
...
For my opening training, I’ll be using [chess.com](http://chess.com/) and analyzing the moves for my selected opening repertoire.
...
I’ll also be using [Chessable.com](http://chessable.com/) and its training programs.
...
Using Chessable to sharpen my knowledge of the Sicilian Defense as black
...
I plan to extensively review my games using the [Chess.com](http://chess.com/) engine and the [Decode Chess engine](https://decodechess.com/ref/68/).

[Chess.com](http://chess.com/)’s engine has a more aesthetically pleasing interface, but [Decode Chess](https://decodechess.com/ref/68/) gives a more thorough explanation about why a certain move was a good idea, why it was not, and some ideas about alternative moves instead.

The engine on [Chess.com](http://chess.com/) also provides some descriptions, but it’s not at the level of detail as Decode Chess. If anyone is looking to replicate this plan to improve their chess, my suggestions are as follows

### Decode Chess vs. Chess.com

[Decode Chess](https://decodechess.com/ref/68/) is good if you don’t quite understand the chess strategy behind why the computer might suggest a move. It gives multiple positives for the best move and multiple negatives for the worst. With Decode Chess, you get more information about why a move you made in the game was no good.

[Chess.com](http://chess.com/) only gives you the most potent idea when it suggests better moves or when it tells you what’s wrong. A stronger player will be able to understand the suggestions of [chess.com](http://chess.com/) without the additional commentary.

I’m using both to review my games because while I have access to a coach who can explain truly difficult ideas and points to me, and I’m strong enough to understand the reasoning behind most of [Chess.com](http://chess.com/) suggestions, Decode Chess sometimes offers a more detailed look into why a move isn’t the best.

Using the [Chess.com](http://chess.com/) terminology, it’s pretty easy to see why a move is a “mistake” or an outright “blunder.” The bigger challenge is seeing why a move is only “good” and not the “best” you could have played in that position. Decode Chess will help me to better understand that.
...
These are all different things I’ve read or what the literature suggests. Even [Chess.com](http://chess.com/)’s definition—the official website for all things chess—gives a rather nebulous definition of the endgame:
...
Based on the standard and common endgame configurations we study, This was the only commonality I could find between all of the end game training exercises on [Chess.com](http://chess.com/) or in other chess books like Silman’s Complete Endgame Book.

One of the best books on chess there is

My definition will likely change as I grow and develop as a player through this training exercise. If you’re a strong player with ideas for my definition or things I might consider adding, please contact me at [ed@edlatimore.com](mailto:ed@edlatimore.com).
...
I’ll continually update this post as my rating grows and changes. If you’re interested in playing me on [Chess.com](http://chess.com/), my handle is [Ed\_Latimore.](https://www.chess.com/member/ed_latimore)
