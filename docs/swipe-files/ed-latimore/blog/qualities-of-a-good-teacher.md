...
- **Source:** https://edlatimore.com/qualities-of-a-good-teacher
- **Date:** 2022-01-07T22:28:11.000Z
...
[The 3-step problem-solving method](https://edlatimore.com/problem-solving-process) is a slightly more simplified version of the scientific method:
...
In this age of prepackaged online curricula and Google, students can [look up the answer to almost anything](https://www.theatlantic.com/magazine/archive/2008/07/is-google-making-us-stupid/306868/). Problem-solving ability is fading at an alarming rate. Most people now—student or otherwise—just look things up.
...
[My undergraduate degree is in Physics](https://edlatimore.com/is-physics-hard-how-to-study-and-learn-basic-physics)—arguably the most complicated topic there is—and I’ve yet to encounter an idea that could not be explained (to a relatively high level of precision) so simply that a layman could understand it.
...
The best way a teacher can improve their student’s results is to [let them fail](https://www.insidehighered.com/views/2016/08/16/students-focus-too-much-grades-detriment-learning-essay). In academic settings, this is difficult because grades function more like a criminal record than a feedback mechanism. Kids really believe that getting a C in the 9th grade screws them for life.
...
They believe that if it’s difficult, it must not be worth it. [But in order to be successful](https://edlatimore.com/high-value-man), students need to believe the *exact* opposite of that. That’s why when a student asks you a question, you should consider asking it right back to them.
